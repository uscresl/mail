...
import numpy as np
import gym
from softgym.utils.visualization import save_numpy_as_gif, save_numpy_to_mp4
import cv2
...
class FlexEnv(gym.Env):
    ...
    def end_record(self, video_path=None, **kwargs):
        ...
        if video_path is not None:
            # save_numpy_as_gif(np.array(self.video_frames), video_path, **kwargs) # original implementation
            save_numpy_to_mp4(np.array(self.video_frames), video_path)
