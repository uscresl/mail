...
from softgym.envs.cloth_fold_robot_hard import ClothFoldRobotHardEnv
...
from softgym.envs.three_cubes import ThreeCubesEnv
...
env_arg_dict = {
    ...
    'DryCloth': {'observation_mode': 'depth_key_point',
                  ...
                  'use_cached_states': True,
                  'deterministic': False},
    'ThreeCubes': dict(observation_mode='state',
                      action_mode='direct',
                      render=True,
                      headless=True,
                      horizon=3,
