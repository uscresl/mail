...
def main():
    ...
    parser.add_argument('--save_everything_every_tsteps', default=400_000, type=int, help="Save everything (model, training details, replay buffer, etc.) as a checkpoint (for resume training) to disk")
    ...
    if args.env_name == 'ThreeCubes' and args.enable_animations:
        env_kwargs['env_kwargs']['enable_animations'] = args.enable_animations
