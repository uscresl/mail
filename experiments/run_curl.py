...
def main():
    ...
    parser.add_argument('--convert_two_arms_to_one_arm', default=False, type=str2bool, help="convert two-arms dataset to one-arm dataset")
    ...
    parser.add_argument('--env_kwargs_enable_fwd_model', default=False, type=str2bool, help='Whether to use forward dynamics model instead of softgym simulator')
    parser.add_argument('--env_kwargs_pretrained_fwd_dyn_ckpt', default=None, type=str, help="File path to pre-trained forward dynamics model's checkpoint")
    parser.add_argument('--two_arms_expert_data',       default=None, type=str, help='File path to two-arms-teacher dataset for evaluation')
    parser.add_argument('--env_kwargs_two_arms_expert_data', default=None, type=str, help='File path to two-arms-teacher dataset for training')
