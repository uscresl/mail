...
class Workspace(object):
    ...
    def eval_gen_videos(self):
        for episode in range(50):
            ...
            if self.env.action_mode == 'pickerpickandplace':
            ...
            while not done:
                ...
                ep_normalized_perf.append(info['normalized_performance'])
            if self.env.action_mode == 'pickerpickandplace':
                self.env.end_record(video_path=os.path.join(self.video_dir, f'ep_{episode}_pickandplace_{ep_normalized_perf[-1]}.gif'))
            else:
