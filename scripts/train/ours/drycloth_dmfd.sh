# NOTE: replace rsi_file with your file generated from running ./scripts/train/ours/drycloth_gen_student_dataset.sh
...
--val_freq=4000 \
--rsi_file=data/cem_2armsto1/ABL_DryCloth_OneArmStudentDataset_300eps_12.22.10.05_11/one_arm_dataset_100eps.pkl \
--batch_size=256 \
--val_num_eps=10 \
--add_sac_loss=True \
--sac_loss_weight=0.1 \
