...
from utils.utils import str2bool, make_dir, set_seed_everywhere
from tqdm import tqdm

from VCD.utils.camera_utils import get_world_coords
from VCD.utils.utils import voxelize_pointcloud
from main_plan import get_rgbd_and_mask
...
def main():
    ...
    parser.add_argument('--cached_states_path', type=str, default=None, help='Overwrite cached_states_path')
    ...
    while not is_done_generating:
        ...
        # get goal state point cloud data
        ...
        goal_pointcloud_trajs.append(voxel_pc)
    ...
    if args.save_dir:
        ...
        goal_pointcloud_trajs=np.array(goal_pointcloud_trajs),
